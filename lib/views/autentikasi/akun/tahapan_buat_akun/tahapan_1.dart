...
class Tahapan1 extends StatelessWidget {
    ...
    return Padding(
      ...
      child: Column(
        ...
        children: [
          ...
          Text('Berapa umurmu?', style: CustomTextStyles.bold2xl.copyWith(color: CustomColors.neutral700)), // Disesuaikan agar konsisten
